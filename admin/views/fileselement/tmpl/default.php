...
<form action="index.php?option=com_seminarman&amp;view=fileselement&amp;tmpl=component" method="post" name="adminForm">
	...
	<thead>
		<tr>
			...
			<th class="proc1" nowrap="nowrap"><?php echo JHTML::_('grid.sort', 'COM_SEMINARMAN_ID', 'f.id', $this->lists['order_Dir'], $this->lists['order']); ?></th>
		</tr>
	</thead>
