...
<form action="index.php?option=com_seminarman&amp;view=courseelement&amp;tmpl=component" method="post" name="adminForm">
...
<table class="adminlist cellspace1">
	<thead>
		<tr>
			...
			<th class="proc1" nowrap="nowrap"><?php echo JText::_('JPUBLISHED'); ?></th>
			<th class="proc1" nowrap="nowrap"><?php echo JHTML::_('grid.sort', 'COM_SEMINARMAN_ID', 'i.id', $this->lists['order_Dir'], $this->lists['order']);?></th>
		</tr>
	</thead>
