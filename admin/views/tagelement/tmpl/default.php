...
<form action="index.php?option=com_seminarman&amp;view=tagelement&amp;tmpl=component" method="post" name="adminForm">
...
<table class="adminlist cellspace1">
	<thead>
		<tr>
			...
			<th class="proc1" nowrap="nowrap"><?php echo JHTML::_('grid.sort', 'COM_SEMINARMAN_ID', 't.id', $this->lists['order_Dir'], $this->lists['order']); ?></th>
		</tr>
	</thead>
