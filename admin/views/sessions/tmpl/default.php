...
echo JHTML::_('grid.sort', 'COM_SEMINARMAN_DATE', 'a.session_date', $this->lists['order_Dir'], $this->
	lists['order']);
...
echo JHTML::_('grid.sort', 'COM_SEMINARMAN_START', 'a.start_time', $this->lists['order_Dir'], $this->
	lists['order']);
...
echo JHTML::_('grid.sort', 'COM_SEMINARMAN_FINISH', 'a.finish_time', $this->lists['order_Dir'], $this->
	lists['order']);
...
echo JHTML::_('grid.sort', 'COM_SEMINARMAN_COURSE', 'c.title', $this->lists['order_Dir'],
	$this->lists['order']);
...
?>
         ...
         <td align="center">
            <?php
             ...
             echo JHTML::date($row->session_date, JText::_('COM_SEMINARMAN_DATE_FORMAT1'));
          ...
          <td align="center">
            <?php
        echo date('H:i', strtotime($row->finish_time));
            ?>
         </td>
          <td align="center">
            <?php
