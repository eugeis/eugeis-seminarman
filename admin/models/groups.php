...
class seminarmanModelgroups extends JModelLegacy
{
    var $_data = null;
    ...
    function _buildQuery()
    {
        ...
        $query = ' SELECT a.id, a.title, a.code, a.date, a.hits, a.published, a.checked_out, a.checked_out_time, a.ordering, a.archived, a.approved, a.params, u.name AS editor ' .
            ' FROM #__profinvent_groups AS a ' .
            ' LEFT JOIN #__users AS u ON u.id = a.checked_out ' . $where . $orderby;
    ...
    function _buildContentOrderBy()
    {
        ...
        $filter_order = $mainframe->getUserStateFromRequest('com_seminarman' .
            '.groups.filter_order', 'filter_order', 'a.ordering', 'cmd');
        $filter_order_Dir = $mainframe->getUserStateFromRequest('com_seminarman' .
            '.groups.filter_order_Dir', 'filter_order_Dir', '', 'word');
    ...
    function _buildContentWhere()
    {
        ...
        $filter_order_Dir = $mainframe->getUserStateFromRequest('com_seminarman' .
            '.groups.filter_order_Dir', 'filter_order_Dir', '', 'word');
        $search = $mainframe->getUserStateFromRequest('com_seminarman' . '.groups.search',
            'search', '', 'string');
