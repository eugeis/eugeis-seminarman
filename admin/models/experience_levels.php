...
class seminarmanModelExperience_levels extends JModel
{
    var $_data = null;
    ...
    function _buildQuery()
    {
        ...
        $query = ' SELECT a.*, u.name AS editor ' . ' FROM #__seminarman_' . $this->
            childviewname . ' AS a ' . ' LEFT JOIN #__users AS u ON u.id = a.checked_out ' .
            $where . $orderby;
