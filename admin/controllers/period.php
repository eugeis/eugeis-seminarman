...
class seminarmanControllerPeriod extends seminarmanController
{
    ...
    function save()
    {
        ...
        {
        	$link = 'index.php?option=com_seminarman&controller=period&task=edit&cid[]='.(int)$id;
        }
       	else
