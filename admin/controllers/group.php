...
class seminarmanControllerGroup extends seminarmanController
{
    ...
    function __construct($config = array())
    {
        ...
        $this->childviewname = 'group';
        $this->parentviewname = 'groups';
    }
    ...
    function publish()
    {
        ...
        $this->setRedirect('index.php?option=com_seminarman&view=' . $this->
            parentviewname);
    }
