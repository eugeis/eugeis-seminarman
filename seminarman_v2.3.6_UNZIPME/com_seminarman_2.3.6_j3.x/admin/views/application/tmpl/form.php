...
<?php 
  // if (($params->get('invoice_generate') == 1) && ($this->application->price_per_attendee > 0)):
if (!empty($this->application->invoice_filename_prefix) && ($this->application->price_per_attendee > 0)):
?>
...
<?php 
  if (isset($app_params['protocols'])) {
    ...
    foreach($protocols as $protocol) {
    	...
    	echo "<tr><td>" . $protocol['date'] . "</td><td>" . $protocol['user'] . "</td><td>" . $stati_text . "</td></tr>";
    }
