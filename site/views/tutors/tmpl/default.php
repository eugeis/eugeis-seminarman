...
<a href="<?php echo JRoute::_('index.php?option=com_seminarman&view=tutor&id=' . $tutor->tutor_slug . '&Itemid=' . $Itemid); ?>"><img src="<?php echo $this->siteurl . 'images/' . $tutor->tutor_photo; ?>"></a>
</div>
